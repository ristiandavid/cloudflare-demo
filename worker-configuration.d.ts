/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1d0e6204860dfad46d05394eca40025c)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		BROWSER: Fetcher;
		AI: Ai;
		DAILY_TRIAGE: Workflow<Parameters<import("./src/index").DailyTriageWorkflow['run']>[0]['payload']>;
	}
}
